...
Partial Class SECGEN_TD_frmBuscarRoles
...
#Region "Metodos"
    ...
    Private Sub InitializeData()
        ...
        'Try
        '    Dim dtResult = PrincipalBR.SelectByCriterio(String.Empty, 2)
    ...
    Private Sub Buscar()
        Try
            ...
            Dim list = PrincipalBR.SelectByCriterio(Name, 2)
...
#Region "Eventos"
    ...
    Protected Sub btnNuevoServicio_Click(sender As Object, e As EventArgs) Handles btnNuevoServicio.Click
        Try
            ...
            Response.Redirect("frmRegistrarRoles.aspx")
        Catch ex As Exception
            Throw ex
        End Try
    End Sub
    ...
    Protected Sub gvwDocsReferenciados_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles gvwDocsReferenciados.RowCommand
        Try
            If e.CommandName = "Seleccionar" Then
                ...
                Dim Name = gvwDocsReferenciados.Rows.Item(fila).Cells(2).Text.Split("-")
